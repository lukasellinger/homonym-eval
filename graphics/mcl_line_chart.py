...
def create_mcl_multi_line_chart(data, axis='model', type_ = 'complete', lang=None):
    if axis == 'model':
        models = {
    ...
    plt.tight_layout()
    plt.savefig(f'multi-overview-{axis}-{type_}{f'-{lang}' if lang else ''}.png', dpi=300, bbox_inches="tight")
    plt.show()