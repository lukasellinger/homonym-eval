...
dataset_name = 'homonym-high-freq-homonymy-wsd'
dataset = load_dataset(f'lukasellinger/{dataset_name}')['train'].to_list()

for context in tqdm([False], desc="HoWN Contexts"):
    for prompt_type in tqdm(['child', 'simple', 'normal'], leave=False):
